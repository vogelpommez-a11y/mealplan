 ...
 */
  ...
  const FOODS = [
    ...
    ["Laugenbrezel", 280, 55, 9, 2.5, "g", "Brezn Breze", 80], ["Croissant", 420, 45, 8, 22, "g", "Hörnchen", 60],
    ["Berliner", 320, 44, 7, 13, "g", "Krapfen Pfannkuchen Kräppel", 80],
    ["Donut", 400, 48, 6, 22, "g", "Doughnut", 60],
    ["Muffin", 440, 50, 6, 24, "g", null, 90],
    ["Naan-Brot", 310, 50, 9, 8],
    // Fleisch und Wurst
    ...
    ["Ei, Größe M", 80, 0.4, 7, 5.7, "st"], ["Ei, Größe L", 95, 0.5, 8, 6.7, "st"],
    ["Ei, Größe S", 66, 0.3, 6, 4.7, "st"], ["Eiklar", 52, 0.7, 11, 0.2],
    ...
    ["Snackpaprika", 37, 6, 1, 0.4, "g", "Minipaprika Spitzpaprika", 30],
    ["Tomaten", 18, 3, 0.9, 0.2, "g", "Paradeiser Tomate", 90], ["Kirschtomaten", 20, 3.4, 0.9, 0.2, "g", null, 15],
    ["Passierte Tomaten", 32, 5, 1.4, 0.2], ["Tomatenmark", 80, 13, 4, 0.5],
    ["Gurke", 12, 1.8, 0.6, 0.1], ["Snackgurke", 12, 1.8, 0.6, 0.1, "g", "Minigurke", 100], ["Eisbergsalat", 13, 2, 0.9, 0.2],
    ...
    ["Rote Bete", 43, 8, 1.5, 0.2], ["Radieschen", 15, 2, 1, 0.1, "g", null, 8],
    ["Mais, Dose", 90, 16, 3, 1.2], ["Grüne Bohnen", 32, 5, 2.4, 0.2],
    ["Spargel", 20, 2, 2, 0.2], ["Avocado", 160, 1, 2, 15, "g", null, 150],
    ["Oliven, grün", 145, 1, 1, 14, "g", null, 4], ["Ingwer", 80, 15, 1.8, 0.8],
    ...
    ["Erdbeeren", 32, 6, 0.7, 0.3, "g", null, 12], ["Heidelbeeren", 45, 9, 0.7, 0.3],
    ["Himbeeren", 34, 5, 1.2, 0.3], ["Weintrauben", 70, 16, 0.7, 0.2],
    ["Kiwi", 60, 11, 1, 0.5, "g", null, 75], ["Ananas", 50, 12, 0.5, 0.1],
    ["Mango", 60, 13, 0.8, 0.4, "g", null, 200], ["Wassermelone", 30, 7, 0.6, 0.2],
    ...
    ["Pflaumen", 46, 10, 0.7, 0.3, "g", null, 30], ["Kirschen", 63, 14, 1, 0.2, "g", null, 8],
    ["Nektarine", 44, 9, 1.1, 0.3, "g", null, 130], ["Granatapfel", 68, 14, 1.5, 0.5],
    ["Papaya", 43, 8, 0.6, 0.3], ["Kaki", 71, 16, 1, 0.3, "g", "Sharonfrucht Persimone", 170],
    ["Zwetschge", 43, 9, 1, 0.1, "g", "Zwetschgen", 25],
    ["Grapefruit", 42, 11, 0.8, 0.1, "g", "Pampelmuse", 200], ["Feigen, frisch", 65, 14, 0.8, 0.3, "g", null, 50],

 ...
 */
  ...
  const DATENSCHUTZ_HTML = `
      ...
      <p>Wir speichern deine Daten, solange dein Konto besteht – mit drei Ausnahmen, die von selbst ablaufen. Erstens dein <strong>Wochenarchiv</strong>: Die Kennzahlen vergangener Kalenderwochen (Ziffer 3) bewahren wir nur für das laufende und die beiden vorangegangenen <strong>Kalenderjahre</strong> auf; Älteres entfernt die App automatisch, auch wenn dein Konto bestehen bleibt. Zweitens: Einträge, die du
         ...
         automatisch ab. Aus dem laufenden Betrieb ist dein Konto sofort verschwunden. Nur ein technischer Sperrvermerk (deine Kontokennung und ein Ablaufzeitpunkt) bleibt noch bestehen: Zwei Stunden lang verhindert er, dass ein noch angemeldetes zweites Gerät Neues anlegt; danach entfernen wir ihn bei unserer nächsten Wartung. Das schließt deinen <strong>Pro-Status</strong> (siehe Ziffer 3) ein, der zusammen mit dem Konto entfernt wird,

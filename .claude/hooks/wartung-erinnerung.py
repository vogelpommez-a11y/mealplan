...
def main():
    ...
    text = (
        ...
        "Drei Schritte, zusammen wenige Minuten:\n\n"
        "  0. python tools/firestore-backup.py\n"
        "     Sichert die Cloud und raeumt abgelaufene Loeschsperren weg. Die\n"
        "     Datenschutzerklaerung (Ziffer 10) sagt zu, dass das bei jeder Wartung passiert.\n\n"
